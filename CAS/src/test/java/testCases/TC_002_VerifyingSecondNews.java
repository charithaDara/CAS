...
public class TC_002_VerifyingSecondNews  extends baseclass
{	
	...
	//capture the user information.
		...
		void UserInfo() throws InterruptedException
		{
			...
			logger.info("Clciking on the User Icon");
	...
	{
		logger.info("Starting the Test Case");
		WebElement header2 = obj.tiptop2;
	...
	public void description() 
	{
		...
		logger.info("Printing the Info To Console");
		System.out.println("Title of News Number 2 :" + NewsTitle1);
	...
	void validateAuthor() throws InterruptedException, IOException
	{
		...
		baseobj.captureScreen("secondNews");
		logger.info("Clciking on the Associate Info Icon");
