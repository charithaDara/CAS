...
public class TC_003_VerifyingThirdNews extends baseclass
{	
	...
	{
		logger.info("Starting the Test Case");
		WebElement header2 = obj.tiptop3;
	...
	public void description()  
	{
		...
		logger.info("Printing the Info To Console");
		System.out.println("Title of News Number 3 :" + NewsTitle1);
	...
	void validateAuthor() throws InterruptedException, IOException
	{
		...
		WebElement i3 = obj.authoR;
		baseobj.captureScreen("thirdNews");
		logger.info("Clicking on Associate Info Icon");
		act33.moveToElement(i3).click().build().perform();
